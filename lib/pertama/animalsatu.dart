...
class AnimalSatu extends StatefulWidget {
  @override
  _AnimalSatuState createState() => _AnimalSatuState();
}

class _AnimalSatuState extends State<AnimalSatu> {
...
// Platform messages are asynchronous, so we initialize in an async method.
  Future<void> setWallpaperFromAsset() async {
    ...
    String result;
    String assetPath = "assets/images/animal1.jpg";
