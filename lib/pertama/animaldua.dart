...
class AnimalDua extends StatefulWidget {
  @override
  _AnimalDuaState createState() => _AnimalDuaState();
}

class _AnimalDuaState extends State<AnimalDua> {
...
// Platform messages are asynchronous, so we initialize in an async method.
  Future<void> setWallpaperFromAsset() async {
    ...
    String result;
    String assetPath = "assets/images/animal2.jpg";
