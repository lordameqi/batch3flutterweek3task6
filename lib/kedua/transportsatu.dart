...
class TransportSatu extends StatefulWidget {
  @override
  _TransportSatuState createState() => _TransportSatuState();
}

class _TransportSatuState extends State<TransportSatu> {
...
// Platform messages are asynchronous, so we initialize in an async method.
  Future<void> setWallpaperFromAsset() async {
    ...
    String result;
    String assetPath = "assets/images/transport1.jpg";
