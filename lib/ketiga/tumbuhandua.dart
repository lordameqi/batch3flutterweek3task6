...
class TumbuhanDua extends StatefulWidget {
  @override
  _TumbuhanDuaState createState() => _TumbuhanDuaState();
}

class _TumbuhanDuaState extends State<TumbuhanDua> {
...
// Platform messages are asynchronous, so we initialize in an async method.
  Future<void> setWallpaperFromAsset() async {
    ...
    String result;
    String assetPath = "assets/images/tumbuhan2.jpg";
