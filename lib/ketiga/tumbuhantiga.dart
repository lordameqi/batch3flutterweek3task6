...
class TumbuhanTiga extends StatefulWidget {
  @override
  _TumbuhanTigaState createState() => _TumbuhanTigaState();
}

class _TumbuhanTigaState extends State<TumbuhanTiga> {
...
// Platform messages are asynchronous, so we initialize in an async method.
  Future<void> setWallpaperFromAsset() async {
    ...
    String result;
    String assetPath = "assets/images/tumbuhan3.JPG";
